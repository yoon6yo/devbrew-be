...
class IdeaServiceTest {
    ...
    fun `updateScore sets score, reason and transitions to SCORED`() {
        ...
        val result = service.updateScore(1L, ScoreResult(8.toShort(), 8.toShort(), 8.toShort(), 8.toShort(), 8.toShort(), 8.toShort(), "Good market fit"))
    ...
    fun `updateScore persists via repository`() {
        ...
        service.updateScore(1L, ScoreResult(9.toShort(), 9.toShort(), 9.toShort(), 9.toShort(), 9.toShort(), 9.toShort(), "Excellent"))
