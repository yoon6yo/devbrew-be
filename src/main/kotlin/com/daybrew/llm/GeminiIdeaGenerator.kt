...
{
  "title": "이 서비스가 무엇을 하는지 바로 알 수 있는 설명형 제목. 브랜드명·제품명 스타일 금지. '누가 + 무엇을 + 어떻게' 구조. 예: '1인 SaaS 이탈 사용자 자동 복귀 이메일', 'GitHub 트렌드 기반 SaaS 아이디어 일간 요약', '프리랜서 계약서 자동 생성 및 전자서명 도구'. 한국어, 20자 이내.",
